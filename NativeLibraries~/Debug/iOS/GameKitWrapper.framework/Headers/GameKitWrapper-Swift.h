...
SWIFT_EXTERN void GKVoiceChat_PlayerVoiceChatStateDidChangeHandler(void * _Nonnull pointer, void (* _Nonnull callback)(void * _Nonnull, void * _Nonnull, enum GKVoiceChatPlayerState));
